...
*/
if exists (select * from sys.procedures where name = 'uspInfoRepresentanteFindAll')
  DROP PROCEDURE [dbo].[uspInfoRepresentanteFindAll]
GO

CREATE PROCEDURE [dbo].[uspInfoRepresentanteFindAll]
...
BEGIN
	...
	WHERE [IR].[InscripcionID] = @InscripcionID
